...
The family of IEC 62439 standards defines a set of ethernet extensions, allowing it's deployment in industrial communication networks, assuring high availability.
