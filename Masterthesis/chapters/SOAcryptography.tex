...
strings of same length is equal, as shown in figure \ref{fig:uniform}, yielding an \textit{uniform distribution}. 
...
The \gls{dh} protocol can be based on a different kind of cyclic groups, namely groups based on \glspl{ec}. An \gls{ec} is basically the set of all points
...
this curve is defined by a "chord-and-tangent" rule together with an imaginary point "in infinity" serving as additive neutral element. Figure \ref{fig:ecAdd}
