...
depending on the message space, there is a finite number of possible cleartext messages, each occurring with its own \textit{a priori} probability. These messages are encrypted
...
\\
Under these assumptions, only \ref{encThenMac} is considered generically secure against chosen plaintext attacks.
