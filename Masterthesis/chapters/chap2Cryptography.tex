...
according to the formulas shown in Table \ref{table:feistel}
\\
\begin{center}
\begin{tabular}{ l l}
 \label{table:feistel}
...
Also called "Rijndael" after its developers Joan Daemen und Vincent Rijmen, \gls{aes} is the successor of \gls{3des}, as
